// src/main/java/br/com/redemaisfarma/application/service/PasswordResetService.java
...
public class PasswordResetService {
    ...
    /** Base URL pública (sem barra no fim). */
    ...
    /** Silencioso: não revela se existe conta. */
    @Transactional
    public void solicitarResetPorEmailOuCpf(String emailOuCpf) {
        // limpeza global básica (usados ou muito antigos)
        ...
        // procure do jeito que já tiver implementado no seu repo
        Optional<UsuarioEntity> opt =
                (email != null) ? usuarioRepository.findByEmailOrCpf(email)
        ...
        // invalida tokens antigos desse usuário (boa prática)
        ...
        // ATENÇÃO: rota cliente (bate com seu controller)
    ...
    public boolean aplicarNovaSenha(String token, String novaSenha) {
        ...
        var t = opt.get();
        var u = usuarioRepository.findById(t.getUsuarioId()).orElse(null);
