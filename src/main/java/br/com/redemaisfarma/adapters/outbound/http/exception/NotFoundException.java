...
public class NotFoundException extends ExternalClientException {
    private static final long serialVersionUID = 1L;

    public NotFoundException(String message, String service, String method, String url, Integer status,
