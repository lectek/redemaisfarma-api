...
public class ServerErrorException extends ExternalClientException {
    private static final long serialVersionUID = 1L;

    public ServerErrorException(String message, String service, String method, String url, Integer status,
