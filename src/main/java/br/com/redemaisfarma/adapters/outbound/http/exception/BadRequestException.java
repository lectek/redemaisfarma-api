...
public class BadRequestException extends ExternalClientException {
    private static final long serialVersionUID = 1L;

    public BadRequestException(String message, String service, String method, String url, Integer status,
