...
public class TooManyRequestsException extends ExternalClientException {
    private static final long serialVersionUID = 1L;

    public TooManyRequestsException(String message, String service, String method, String url, Integer status,
