...
public class GatewayTimeoutException extends ExternalClientException {
    private static final long serialVersionUID = 1L;

    public GatewayTimeoutException(String message, String service, String method, String url, Integer status,
