...
public class ForbiddenException extends ExternalClientException {
    private static final long serialVersionUID = 1L;

    public ForbiddenException(String message, String service, String method, String url, Integer status,
