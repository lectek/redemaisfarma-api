...
public class ConflictException extends ExternalClientException {
    private static final long serialVersionUID = 1L;

    public ConflictException(String message, String service, String method, String url, Integer status,
