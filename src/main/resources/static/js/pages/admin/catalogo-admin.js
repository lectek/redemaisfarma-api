  ...
  function renderCard(p) {
    ...
    const acoesCliente = `
      <div class="form-row gap-2 mt-2">
        <button class="btn" data-add-carrinho data-id="${p.id}" ${disponivelCalc ? "" : "disabled"}>
    ...
    const acoesAdmin = `
      <div class="form-row gap-2 mt-2">
        ...
        <button class="btn btn-primary" data-ia-queue data-id="${p.id}">Gerar IA</button>
        <button class="btn btn-ghost" data-ia-regenerate data-id="${p.id}">Regenerar</button>
      </div>`;
